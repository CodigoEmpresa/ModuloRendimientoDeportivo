...
class DeportistaEntrenamiento extends Model
{
    ...
    protected $fillable = ['Deportista_Id', 'Entrenamiento_Id', 'Fecha', 'Numero_Dia', 'Convencion_Asistencia_Id', 'Verificacion_Convencion_1_Id', 'Verificacion_Convencion_2_Id', 'Verificacion_Convencion_3_Id', 'Url_Soporte_Medico', 'Url_Soporte_Calamidad'];
